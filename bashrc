...
#export LESS_TERMCAP_se=$'\e[0;37m'    # start standout
#export LESS_TERMCAP_so=$'\e[0;30;47m' # stop standout
#export LESS_TERMCAP_us=$'\e[4;37m'    # start underline
#export LESS_TERMCAP_ue=$'\e[0;37m'    # stop underline
